...
export IMAGE_URL=rhtap-quay-quay-rhtap-quay.apps.rhopp240814b.devcluster.openshift.com/rhtap/goapp-gh-jenkins-240814:jenkins-$TAG
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/goapp-gh-jenkins-240814-gitops
